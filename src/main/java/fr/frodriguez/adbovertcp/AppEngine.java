...
public final class AppEngine {
     ...
     */
    public static boolean enableAdbOverTcp(Context context) {
        // Get port
     ...
     */
    public static void showNotification(Context context, String title, String message, boolean enableButton) {
